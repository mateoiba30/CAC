...
l.d f1, n1(r0)
l.d f2, n2(r0)
#nop me soluciona RAW y WAR de las 2 lineas de abajo. soluciona el WAR porq el add no se atrasa ahciendo que no coincida con la de mul (el RAW de add nunca atrasa a mul)
add.d f3, f2, f1 #sumo, con RAW porque espera a f2 y tarda varias etapas por operar con flotantes
mul.d f1, f2, f1 #WAR debido a que quiere escribir f1, pero no está disponible porque la isntr de arriba se atraso con la lectura de registros. en realidad para cuando llega el WB de esta instr ya se terminó la elctura de la instr anterior, pero el ssimluador por las dudas atasca 
